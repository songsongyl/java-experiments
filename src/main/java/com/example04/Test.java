...
import com.example04.service.impl.StudentServiceImpl;

import java.util.List;
import java.util.Map;

import static com.example04.entity.Student.Sex.FEMALE;
...
//        });
    ...
    private static void removeStudentTest(){
       ...
       //DatabaseUtils.listStudents().removeIf(student -> 202222==student.getId());
